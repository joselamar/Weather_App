...
import lamarao.jose.wit.software.challenge.model.Daily
...
class rv_weekday_adapter(private val dataSet: List<Daily>, val unit: String): RecyclerView.Adapter<rv_weekday_adapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): rv_weekday_adapter.ViewHolder {
    ...
    override fun onBindViewHolder(viewHolder: rv_weekday_adapter.ViewHolder, position: Int) {
